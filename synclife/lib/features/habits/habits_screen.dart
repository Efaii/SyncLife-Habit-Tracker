...
import '../home/dashboard_screen.dart'; // To get habitsProvider, todayCompletedHabitsProvider, bgColor, primaryBlue
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: habitsAsync.when(
        ...
        error: (error, _) => Center(child: Text('Error: $error', style: TextStyle(color: textColor))),
      ),
    );
  }
}
